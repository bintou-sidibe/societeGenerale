...
class __TwigTemplate_dbcc8a1cf0d8bc70c2354f5aa7a1b535 extends Template
{
    private $source;
    private $macros = [];
...
Symfony Twig Bridge to ensure that all applications building backends with EasyAdmin
use the same version of the templates, even those still using Symfony 4.4.
", "@EasyAdmin/symfony-form-themes/README.txt", "/Applications/MAMP/htdocs/php-decodeuse/app-societe-generale-simple/vendor/easycorp/easyadmin-bundle/src/Resources/views/symfony-form-themes/README.txt");
    }
}
